...
Index.prototype.bindEvents = function (item, index) {
    var self = this;
    $(item).on('mouseenter', function (e) {//因为这里的e代表鼠标mouseenter,
...
Index.prototype.addClass = function (e, item, state, index) {
    ...
    item.className = '';
    item.classList.add(state + class_suffix);//添加样式top-right这类的
};
